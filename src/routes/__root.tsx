...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient; auth: { isAuthenticated: boolean; email: string | null } }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Get — Private shopping intelligence" },
      { name: "description", content: "Know when to buy, and when to wait. Quiet predictions for the brands you care about." },
      { property: "og:title", content: "The Get" },
      { property: "og:description", content: "Private shopping intelligence for considered wardrobes." },
