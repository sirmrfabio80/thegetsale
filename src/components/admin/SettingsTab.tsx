...
import { getPrivateBetaEnabled, setPrivateBetaEnabled } from "@/lib/app-settings.functions";
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">Control who can join The Get.</p>
      </div>
      ...
      <label className="flex items-start gap-4 border border-border p-5 cursor-pointer hover:border-foreground/60 transition-colors">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            When on, the signup page and Google/Apple/email signup buttons are hidden across the
            marketing site. Existing accounts can still sign in. Turn off to open registration to
            anyone.
          </p>
        </div>
      </label>
