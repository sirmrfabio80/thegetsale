...
export const SALE_TYPES = [
  ...
  "outlet_sale",
  "other",
  // Imported from UK market research (May 2026)
  "cyber_monday",
  "black_friday_cyber_monday",
  "black_friday_sale_items",
  "super_friday",
  "friday_sale",
  "boxing_day_end_of_year",
  "new_year_sale",
  "january_sale",
  "retailer_january_sale",
  "winter_archives",
  "fall_winter_archives",
  "end_of_season_sale",
  "end_of_season_outlet",
  "outlet",
  "sample_sale",
  "warehouse_sale",
  "vip_sale",
  ...
  "official_sale",
  "special_prices",
  "limited_red_price_offer",
  "we_made_too_much",
  "bash_days",
  "good_friday_sale",
  "easter_monday_sale",
  "early_may_bank_holiday_sale",
  "spring_bank_holiday_sale",
  "summer_bank_holiday_sale",
] as const;
...
export const SALE_TYPE_LABELS: Record<(typeof SALE_TYPES)[number], string> = {
  ...
  retailer_january_sale: "Retailer January sale",
  ...
  easter_monday_sale: "Easter Monday sale",
  early_may_bank_holiday_sale: "Early May Bank Holiday sale",
  spring_bank_holiday_sale: "Spring Bank Holiday sale",
  summer_bank_holiday_sale: "Summer Bank Holiday sale",
};
